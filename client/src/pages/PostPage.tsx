...
const PostPage = () => {
    ...
    const [recentPosts, setRecentPost] = useState<postProps[] | null>(null);
    ...
    return (
        <main className="p-3 flex flex-col max-w-6xl mx-auto min-h-screen">
            ...
            <div className="flex justify-between p-3 border-b border-slate-500 mx-auto w-full max-w-2xl text-xs">
                ...
                <span className="italic">{post && ((post?.content as string).length / 1000).toFixed(0)} mins read</span>
            </div>
            <div className="p-3 max-w-2xl mx-auto w-full post-content" dangerouslySetInnerHTML={{__html: (post && post?.content) as string}}>
